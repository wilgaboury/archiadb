use zerocopy::{FromBytes, Immutable, IntoBytes, KnownLayout, Unaligned, native_endian::{U32, U64, U128}};

const MAGIC: u128 = 0xa90e3b4b1b0833499933888e3933af0d; // Random GUID
const VERSION: u64 = 0;

#[derive(FromBytes, IntoBytes, Debug, KnownLayout, Immutable, Unaligned)]
#[repr(C)]
struct Meta {
    magic: U128,
    version: U64,
